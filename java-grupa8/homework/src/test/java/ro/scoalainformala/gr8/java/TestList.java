...
public class TestList {
    ...
    public void testFilterCarInStock() {
        Stock[] stock = {new Stock(new Car("Manufactor 1", "Car 1.1", 2016, 75,
        ...
        assertEquals(true, list.getStockItem(1).getCarName().equals("Car 1.2"));
        list.filterCarInStock();
        assertEquals(true, list.getStockItem(1).getCarName().equals("Car 1.3"));
    }
    ...
    public void testFilterNewCar() {
        ...
        assertEquals(null, list.getStockItem(5));
    }
}
